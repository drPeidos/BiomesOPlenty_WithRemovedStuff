...
public class GenLayerBiomesCustom extends GenLayer 
{
	...
	public GenLayerBiomesCustom(long seed, WorldType worldType) 
	{
		...
		this.allowedBiomes = new BiomeGenBase[]{/*BOPBiomeHelper.get(promisedLandDimID, "promisedLandShrub"), */BOPBiomeHelper.get(promisedLandDimID, "wonderousWoods"), BOPBiomeHelper.get(promisedLandDimID, "majesticMeadow"), BOPBiomeHelper.get(promisedLandDimID, "blessedBog")};
	}
